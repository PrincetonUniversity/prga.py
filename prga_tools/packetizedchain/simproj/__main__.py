...
from prga_tools.packetizedchain.simproj.tbgen import generate_testbench_wrapper
from prga_tools.packetizedchain.simproj.mkgen import generate_makefile
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
            description="Simulation project wizard for packetized-chain-style configuration circuitry")
