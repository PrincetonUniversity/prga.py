...
def bitgen_scanchain(total_config_bits  # total number of configuration bits
    ...
    """
    # total_config_bits = context.database[ModuleView.logical, context.top.key].cfg_bitcount
...
if __name__ == '__main__':
    ...
    _logger.info("Total number of configuration bits: {}".format(total_config_bits))
    bitgen_scanchain(total_config_bits, args.fasm, args.memh)
