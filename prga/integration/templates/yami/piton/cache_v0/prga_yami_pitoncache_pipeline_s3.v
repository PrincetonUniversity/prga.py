...
module prga_yami_pitoncache_pipeline_s3 (
    ...
    , output wire [`PRGA_YAMI_CACHE_ROB_NUM_ENTRIES_LOG2-1:0]   rpb_rob_entry_s3

    // -- To ILQ -------------------------------------------------------------
    // ILQ (in-flight load queue) full checked at S1
    , output reg                                                ilq_wr_s3
    , output wire                                               ilq_nc_s3
    , output wire [`PRGA_YAMI_CACHE_INDEX_WIDTH-1:0]            ilq_index_s3
    , output wire [`PRGA_YAMI_CACHE_NUM_WAYS_LOG2-1:0]          ilq_way_s3
    ...
    always @(posedge clk) begin
        if (~rst_n) begin
            ...
            rob_fill_entry_s3 <= { `PRGA_YAMI_CACHE_ROB_NUM_ENTRIES_LOG2 {1'b0} };
            ...
            rob_fill_entry_s3 <= rob_entry_s3_next;
        end
    end
    ...
    assign rpb_rob_entry_s3 = rob_fill_entry_s3;
