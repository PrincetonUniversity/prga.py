...
module prga_yami_pitoncache #(
    ...
    wire [`PRGA_YAMI_CACHE_NUM_WAYS_LOG2-1:0]   way_s3, hit_rpl_way_s3;

    wire lru_array_busy_s2, tag_array_busy_s2, state_array_busy_s2;
    wire lru_array_rd_s2, tag_array_rd_s2, state_array_rd_s2, data_array_rd_s2;
    wire lru_array_wr_s3, tag_array_wr_s3, data_array_wr_s3;

    wire [`PRGA_YAMI_MFC_DATA_BYTES-1:0] data_array_wstrb_s3;
    wire [`PRGA_YAMI_MFC_DATA_WIDTH-1:0] data_array_rdata_s3, data_array_wdata_s3;

    wire [`PRGA_YAMI_CACHE_NUM_WAYS * `PRGA_YAMI_CACHE_LRU_WIDTH-1:0]   lru_array_rdata_s3;
    ...
    wire rob_next_entry_vld_s2, rob_alloc_s2, rob_fill_s3;
    wire [`PRGA_YAMI_CACHE_ROB_NUM_ENTRIES_LOG2-1:0] rob_next_entry_s2, rob_fill_entry_s3;
    wire [`PRGA_YAMI_RESPTYPE_WIDTH-1:0] rob_alloc_resptype_s2;
    ...
    wire stall_s2;
    wire [`PRGA_YAMI_CACHE_S2OP_WIDTH-1:0] op_s2_next;
    wire [`PRGA_YAMI_CACHE_NUM_WAYS_LOG2-1:0] inv_way_s2_next;
    ...
    wire [`PRGA_YAMI_CACHE_ROB_NUM_ENTRIES_LOG2-1:0] rpb_rob_entry_s2_next;

    wire stall_s3;
    wire [`PRGA_YAMI_CACHE_S3OP_WIDTH-1:0] op_s3_next;
    wire [`PRGA_YAMI_CACHE_NUM_WAYS_LOG2-1:0] inv_ilq_way_s3_next;
    wire [`PRGA_YAMI_REQTYPE_WIDTH-1:0] reqtype_s3_next;
    wire [`PRGA_YAMI_SIZE_WIDTH-1:0] size_s3_next;
    wire [`PRGA_YAMI_FMC_ADDR_WIDTH-1:0] addr_s3_next;
    ...
    prga_yami_pitoncache_lru_array #(
        ...
        ,.USE_INITIAL_BLOCK     (USE_INITIAL_BLOCK)
    ) i_lru_array (
        .clk                    (clk)
        ,.rst_n                 (rst_n)
        ,.busy_s2               (lru_array_busy_s2)
        ,.rd_s2                 (lru_array_rd_s2)
        ,.index_s2              (index_s2)
        ,.rdata_s3              (lru_array_rdata_s3)
    ...
    prga_yami_pitoncache_state_array #(
        ...
        .clk                    (clk)
        ,.rst_n                 (rst_n)
        ,.busy_s2               (state_array_busy_s2)
        ,.rd_s2                 (state_array_rd_s2)
        ,.index_s2              (index_s2)
        ,.rdata_s3              (state_array_rdata_s3)
    ...
    prga_yami_pitoncache_tag_array #(
        ...
        .clk                    (clk)
        ,.rst_n                 (rst_n)
        ,.busy_s2               (tag_array_busy_s2)
        ,.rd_s2                 (tag_array_rd_s2)
        ,.index_s2              (index_s2)
        ,.rdata_s3              (tag_array_rdata_s3)
    ...
    prga_yami_pitoncache_way_logic i_way_logic (
        .stateline_s3           (state_array_rdata_s3)
        ,.tagline_s3            (tag_array_rdata_s3)
        ,.lruline_s3            (lru_array_rdata_s3)
        ,.tag_s3                (tag_s3)
        ,.hit_s3                (hit_s3)
        ,.iv_s3                 (iv_s3)
    ...
    prga_yami_pitoncache_rob i_rob (
        ...
        ,.mfc_type              (a_mfc_type)
        ,.mfc_data              (a_mfc_data)
        ,.next_entry_vld_s2     (rob_next_entry_vld_s2)
        ,.next_entry_s2         (rob_next_entry_s2)
        ,.alloc_s2              (rob_alloc_s2)
        ,.alloc_resptype_s2     (rob_alloc_resptype_s2)
        ,.fill_s3               (rob_fill_s3)
        ,.fill_entry_s3         (rob_fill_entry_s3)
    ...
    prga_yami_pitoncache_pipeline_s1 i_s1 (
        ...
        ,.rpb_rob_entry_s2_next (rpb_rob_entry_s2_next)
        ,.enqueue_rpb_s3        (enqueue_rpb_s3)
        ,.dequeue_rpb_s1        (dequeue_rpb_s1)
        ,.rpb_empty_s1          (rpb_empty_s1)
        ,.rpb_vld_s1            (rpb_vld_s1)
    ...
    prga_yami_pitoncache_pipeline_s2 i_s2 (
        ...
        ,.reqtype_s3_next       (reqtype_s3_next)
        ,.size_s3_next          (size_s3_next)
        ,.addr_s3_next          (addr_s3_next)
        ,.data_s3_next          (data_s3_next)
        ,.rob_entry_s3_next     (rob_entry_s3_next)
        ,.validate_rpb_s2       (validate_rpb_s2)
        ,.rpb_vld_s2            (rpb_vld_s2)
        ,.rpb_reqtype_s2        (rpb_reqtype_s2)
        ,.rpb_size_s2           (rpb_size_s2)
        ,.rpb_addr_s2           (rpb_addr_s2)
        ,.rpb_data_s2           (rpb_data_s2)
        ,.rob_next_entry_vld_s2 (rob_next_entry_vld_s2)
        ,.rob_next_entry_s2     (rob_next_entry_s2)
        ,.rob_alloc_s2          (rob_alloc_s2)
        ,.rob_alloc_resptype_s2 (rob_alloc_resptype_s2)
        ,.ilq_rd_s2             (ilq_rd_s2)
        ,.ilq_nc_s2             (ilq_nc_s2)
        ,.ilq_index_s2          (ilq_index_s2)
        ,.ilq_way_s2            (ilq_way_s2)
        ,.ilq_offset_s2         (ilq_offset_s2)
        ,.ilq_size_s2           (ilq_size_s2)
        ,.ilq_rob_entry_s2      (ilq_rob_entry_s2)
        ,.isq_rd_s2             (isq_rd_s2)
        ,.isq_nc_s2             (isq_nc_s2)
        ,.isq_rob_entry_s2      (isq_rob_entry_s2)
        ,.imq_rd_s2             (imq_rd_s2)
        ,.imq_offset_s2         (imq_offset_s2)
        ,.imq_size_s2           (imq_size_s2)
        ,.imq_rob_entry_s2      (imq_rob_entry_s2)
        ,.lru_array_busy_s2     (lru_array_busy_s2)
        ,.tag_array_busy_s2     (tag_array_busy_s2)
        ,.state_array_busy_s2   (state_array_busy_s2)
        ,.index_s2              (index_s2)
        ,.lru_array_rd_s2       (lru_array_rd_s2)
        ,.tag_array_rd_s2       (tag_array_rd_s2)
        ,.state_array_rd_s2     (state_array_rd_s2)
    ...
    prga_yami_pitoncache_pipeline_s3 i_s3 (
        ...
        ,.rob_fill_entry_s3     (rob_fill_entry_s3)
        ...
        ,.ilq_wr_s3             (ilq_wr_s3)
        ,.ilq_nc_s3             (ilq_nc_s3)
        ,.ilq_index_s3          (ilq_index_s3)
        ,.ilq_way_s3            (ilq_way_s3)
        ,.ilq_offset_s3         (ilq_offset_s3)
        ,.ilq_size_s3           (ilq_size_s3)
        ,.ilq_rob_entry_s3      (ilq_rob_entry_s3)
        ,.isq_wr_s3             (isq_wr_s3)
        ,.isq_nc_s3             (isq_nc_s3)
        ,.isq_rob_entry_s3      (isq_rob_entry_s3)
        ,.imq_wr_s3             (imq_wr_s3)
        ,.imq_offset_s3         (imq_offset_s3)
        ,.imq_size_s3           (imq_size_s3)
        ,.imq_rob_entry_s3      (imq_rob_entry_s3)
        ,.m_fmc_rdy             (m_fmc_rdy)
        ,.m_fmc_vld             (m_fmc_vld)
