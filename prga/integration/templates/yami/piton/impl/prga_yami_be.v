...
module prga_yami_be #(
    parameter   DEFAULT_FEATURES    = `PRGA_YAMI_CREG_FEATURE_LOAD
    ...
    assign mfc_l1invall = fifo_mfc_data[`PRGA_YAMI_MFC_FIFO_L1INVALL_INDEX];
    assign mfc_l1invway = fifo_mfc_data[`PRGA_YAMI_MFC_FIFO_L1INVWAY_INDEX];
    ...
    always @* begin
        ...
        if (fmc_creg_vld) begin
            ...
            fifo_fmc_data[`PRGA_YAMI_FMC_FIFO_L1RPLWAY_INDEX] = fmc_l1rplway;
        end
    end
