...
# -- Phony rules -------------------------------------------------------------
# ----------------------------------------------------------------------------
.PHONY: verify synth pack bind place route fasm bitgen compile waveform clean cleanlog cleanall makefile_validation_ disp backup
...
$(BITGEN_RESULT): $(SUMMARY) $(FASM_RESULT)
	$(PYTHON) -m prga.tools.pktchain.bitgen $^ $@
