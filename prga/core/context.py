...
from .builder.array.leaf import LeafArrayBuilder
...
class Context(Object):
    ...
    def build_array(self, name, width = 1, height = 1, *,
        ...
        Keyword Args:
            ...
            hierarchical (:obj:`bool`): If set to ``True``, create a non-leaf array; otherwise create a leaf array.
                Only tiles and switch boxes can be added into a leaf array, while only arrays can be added into a
                non-leaf array
        ...
        builder_factory = LeafArrayBuilder
