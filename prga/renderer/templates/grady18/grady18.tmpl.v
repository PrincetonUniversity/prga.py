    ...
    always @(posedge clk) begin
        if (~prog_done) begin
            ...
            case (ble5a_mode)
                ...
                BLE5_MODE_ARITH:    internal_ff[0] <= internal_sum[0][0];
                BLE5_MODE_LUT5:     internal_ff[0] <= internal_lut5[0];
                BLE5_MODE_LUT6:     internal_ff[0] <= internal_lut6;
            endcase

            // BLE5B
            case (ble5b_mode)
                BLE5_MODE_DISABLED: internal_ff[1] <= 1'b0;
                BLE5_MODE_ARITH:    internal_ff[1] <= internal_sum[1][0];
                BLE5_MODE_LUT5:     internal_ff[1] <= internal_lut5[1];
                BLE5_MODE_LUT6:     internal_ff[1] <= 1'b0;
            endcase
        end
    end
