...
{%- set num_cfg_units_per_frame = frame_size // cfg_width %}
...
module pktchain_clasp (
    ...
    localparam  UNIT_COUNTER_WIDTH = {{ (num_cfg_units_per_frame - 1).bit_length() }};  // $clog2(NUM_CFG_UNITS_PER_FRAME)
