...
# ----------------------------------------------------------------------------
class YosysTemplateEntry(namedtuple('YosysTemplateEntry',
    'lib_template techmap_template parameters premap_commands')):
    ...
    Args:
        ...
        premap_commands (:obj:`Sequence` [:obj:`str` ]): Pre-techmap commands
    """

    def __new__(cls, lib_template = None, techmap_template = None, parameters = None, premap_commands = None):
        return super(YosysTemplateEntry, cls).__new__(cls, uno(lib_template,'blackbox.lib.tmpl.v'),
                techmap_template, uno(parameters, {}), uno(premap_commands, tuple()))
...
class YosysMemoryTemplateEntry(namedtuple('YosysMemoryTemplateEntry',
    ...
    def __new__(cls, lib_template = None, techmap_template = None, rule_template = None, parameters = None,
        ...
        return super(YosysMemoryTemplateEntry, cls).__new__(cls, uno(lib_template,'blackbox.lib.tmpl.v'),
                techmap_template, rule_template, uno(parameters, {}), uno(premap_commands, tuple()))
...
class YosysTemplateRegistry(Object):
    ...
    def register_memory_template(self, name, lib_template = None, techmap_template = None, rule_template = None,
            parameters = None, premap_commands = None):
        ...
        return self._memory_entries.setdefault(name, YosysMemoryTemplateEntry(lib_template, techmap_template,
            rule_template, parameters, premap_commands))
...
class YosysGenerator(object):
    ...
    def generate_script(self, output, abc_luts, libraries = None, memory_techmaps = None, techmaps = None):
        """Generate YOSYS synthesis script.

        Args:
            output (file-like object):
            abc_luts (:obj:`str`): Argument for the ``abc -luts`` in Yosys
            libraries (:obj:`Sequence` [:obj:`str` ]): A list of blackbox libraries
            memory_techmaps (:obj:`Sequence` [:obj:`Mapping` [:obj:`str`, :obj:`str` ]]): A list of memory techmaps.
                Each element must have the following keywords: ``"rule"``, the BRAM mapping rule file; and
                ``"techmap"``, the techmap file. An optional keyword, ``"premap_commands"``, may be used to specify a
                list of pre-techmap commands in Yosys
            techmaps (:obj:`Sequence` [:obj:`Mapping` [:obj:`str`, :obj:`str` ]]): A list of other techmaps. Each
                element must have the keyword ``"techmap"``, the techmap file. An optional keyword,
                ``"premap_commands"``, may be used to specify a list of pre-techmap commands in Yosys
        """
        self.env.get_template("synth.tmpl.ys").stream({
            "libraries": uno(libraries, tuple()),
            "memory_techmaps": uno(memory_techmaps, tuple()),
            "techmaps": uno(techmaps, tuple()),
            "abc_luts": abc_luts}).dump(output, encoding='ascii')
